#
#  Be sure to run `pod spec lint DTTracker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "灵吾" => "liuyunclouder@gmail.com" }
  # Or just: s.author    = "灵吾"
  # s.authors            = { "灵吾" => "liuyunclouder@gmail.com" }
  # s.social_media_url   = "http://twitter.com/灵吾"
